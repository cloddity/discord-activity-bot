...
async def on_message(message):
    ...
    #if message.content.startswith('^statfacts'):
        #await client.send_message(message.channel, "**9/29/16** is the only day in which the collective number of admin+ messages exceeds **5000** in #general.")
